...
class TestStream(unittest.TestCase):
    ...
    def test_create_function_map_internal_l1(self):
        ...
        fmap = ctdpf_optode_sample.create_function_map(preswat)
    ...
    def test_create_function_map_internal_l2(self):
        ...
        fmap = ctdpf_optode_sample.create_function_map(practical_salinity)
    ...
    def test_create_function_map_external_l2_pdonly(self):
        ...
        fmap = nutnr_a_sample.create_function_map(temp_sal_corrected_nitrate, [ctdpf_optode_sample])
    ...
    def test_create_function_map_external_specific_stream(self):
        ...
        fmap = wavss_a_dcl_mean_directional.create_function_map(wavss_a_directional_frequency,
    ...
    def test_create_function_map_external_dpi(self):
        ...
        fmap = phsen_data_record.create_function_map(ph_seawater, [ctdpf_optode_sample])
